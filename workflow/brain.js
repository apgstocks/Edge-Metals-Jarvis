...
function policyDecide(ctx) {
    ...
    if (ctx.isManagerOrTeam) {
        ...
        // no question — AND something she bought (a container number, the
        // word container/load, or a supplier with bills). "prepare an invoice
        // for Daekwang" names a customer, not a supplier, and is left to go
